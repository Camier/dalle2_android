...
requirements = python3,kivy==2.3.0,kivymd==1.2.0,openai,requests,pillow,cryptography,certifi,urllib3,charset-normalizer,idna,pyjnius
...
#android.library_references = android/src
